...
public class DaoConnection {
    ...
    try {
      if (connection == null) {
        connection = DriverManager.getConnection(
            DAO_MESSAGES_BUNDLE.getString(CONNECTION_PATH),
            DAO_MESSAGES_BUNDLE.getString(ROOT_NAME),
            DAO_MESSAGES_BUNDLE.getString(PASSWORD));
      }
   ...
   * 
   * @param connection
   * Data base close connection method
   */
