...
public class DoctorService<E extends User> implements UserService {
  ...
  @Override
  public List<Doctor> viewUser(int roleId) {
  ...
  public List<Patient> PatientList(int id) throws BusinessExceptionMapper {
    List<Patient> patientList = new ArrayList<Patient>();
    patientList = doctorDaoDb.ListAllPatients(id);
    return patientList;
  }
  public List<Patient> PatientListOfAllDoctor() throws BusinessExceptionMapper {
    List<Patient> patientListOfAllDoctors = new ArrayList<Patient>();
    patientListOfAllDoctors = doctorDaoDb.ListAllPatientsOfAllDoctors();
    return patientListOfAllDoctors;
  }
}
